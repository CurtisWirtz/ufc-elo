...
* I wrote python scripts to gather data on MMA fighters, bouts, and events:
    ...
    * [A scraper](https://github.com/CurtisWirtz/ufc-elo/tree/main/data_mining/scraper) built similarly to [Bucky Robert's open source web crawler](https://github.com/buckyroberts/Spider), which visits each URL discovered by the crawler, then copies data from HTML elements containing specific CSS class names
