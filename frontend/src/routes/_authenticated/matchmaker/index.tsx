    ...
    <Section
      ...
      <div className="bg-background w-full mt-6 items-center min-h-screen">
        ...
        <div className="flex flex-col tablet:flex-row w-full animate-appear relative tablet:space-x-5">
          ...
          <div className="animate-appear z-10 absolute top-1/2 left-1/4 tablet:left-1/2 tablet:-translate-x-1/2 -translate-y-1/2 h-11 w-11 bg-brand-foreground text-black text-2xl rounded-full border-black border-2">
