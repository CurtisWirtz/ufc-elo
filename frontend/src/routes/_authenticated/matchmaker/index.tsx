  ...
  return (
    <Section
      ...
      <div className="bg-background w-full mt-6 items-center min-h-screen">
        ...
        <p className="animate-appear mb-7">Select two fighters from any point in their careers to see who would have been projected to win based their Elo rankings.</p>
        <div className="flex w-full animate-appear relative space-x-5">

          <div className="relative flex flex-col grow-1">
              ...
              <div className="">
                ...
                {(firstFighter && firstFighterEra) ? (
                  <div className="relative">
                    <div className="absolute flex justify-between w-full mt-2 text-lg">
                    ...
                    <div className="relative w-full">
                      <ul className="absolute w-full mt-2 space-y-2 max-h-50 overflow-y-auto">
                        ...
                        {secondFighter.elo_history.map((era) => (
                          <li>
                            <Button key={era.date + era.opponent_id} className="cursor-pointer text-lg text-center w-full flex justify-between" onClick={() => {setSecondFighterEra(era)} }>
                              <span>{formatDate(era.date)}</span>
                              <span>Rating: {Math.round(era.ending_elo)}</span>
                            </Button>
                          </li>
